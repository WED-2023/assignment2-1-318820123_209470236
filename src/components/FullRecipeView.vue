  ...
  <div class="recipe-container">
    ...
    <div class="recipe-body">
      <div class="wrapper">
        <div class="wrapped">
          <div class="mb-3">
            <div>Ready in {{ recipe.preparation_time }} minutes</div>
            <div>Likes: {{ recipe.aggregateLikes }} likes</div>
            <div>Servings: {{ recipe.servings }}</div>
            <div class="icons">
              <img v-if="recipe.vegetarian" src="@/assets/vegetarian.jpg" alt="Vegetarian" class="icon" v-b-tooltip.hover="'Vegetarian'" />
              <img v-if="recipe.vegan" src="@/assets/vegan.jpg" alt="Vegan" class="icon" v-b-tooltip.hover="'Vegan'" />
              <img v-if="recipe.gluten_free" src="@/assets/glutenfree.jpg" alt="Gluten Free" class="icon" v-b-tooltip.hover="'Gluten Free'" />
            </div>
          </div>
          Ingredients:
          <ul>
