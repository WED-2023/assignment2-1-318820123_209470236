  ...
  methods: {
    ...
    async submitRecipe() {
      try {
        ...
        formData.append('title', this.recipeName);
        formData.append('imageUrl', this.imageFile);
        formData.append('preparation_time', this.preparationTime);
        formData.append('vegan', this.isVegan);
        formData.append('vegetarian', this.isVegetarian);
        formData.append('gluten_free', this.isGlutenFree);
